// Offline comparison only. Product browsing uses the complete exploration pool.
import {
    getVoicingTechniqueTag,
    rankVoicingCandidates,
    type ScoreResolvedVoicingOptions,
    type VoicingTechniqueTag,
} from '../../src/domain/chord/deductiveRanking';
import { getCompleteChordWindow } from '../../src/domain/chord/descriptor';
import { buildDeductiveChordTones } from '../../src/domain/chord/degreeRequirements';
import { resolveChordRegistryEntry } from '../../src/domain/chord/helpers';
import { searchDeductiveVoicings, type VoicingSearchOptions } from '../../src/domain/chord/voicingSearch';
import type { VoicingPosition } from '../../src/domain/chord/voicingStyles';
import type { ChordRegistryEntry } from '../../src/domain/chord/registry';
import type { ResolvedVoicing, VoicingCandidate } from '../../src/domain/chord/types';
