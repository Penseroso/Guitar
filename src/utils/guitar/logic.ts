...
// fretboard interpretation (double-stop placement) in one module. Truth now lives in
// notes.ts/degrees.ts/keys.ts, guitar interpretation in doubleStops.ts — re-exported below
// under their original names so existing imports keep working.
