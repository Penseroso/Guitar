...
export function VoicingFactsView({ candidate }: { candidate: PresentationCandidate }) {
    ...
    return <div className={styles.facts}>
        ...
        <p>{candidate.recommendation.eligible ? 'Selected by the recommendation policy.' : 'Outside the recommendation policy; available in All voicings.'}</p>
    </div>;
}
